  ...
  return (
    <header className="flex items-end justify-between gap-3 pb-1">
      <div className="min-w-0">
        <h1 className="truncate font-display text-3xl font-semibold text-inchiostro">{titolo}</h1>
        {sottotitolo && <p className="font-mono text-xs text-inchiostro-debole">{sottotitolo}</p>}
      </div>
      {azione}
    </header>
  );
